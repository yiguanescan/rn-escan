...
import PaymentDrawerDetails from '../paymentDrawerDetails/paymentDrawerDetails'

class paymentDr extends React.Component{
    constructor(props){
        super(props);
        this.state = {
            ...
            this.state.lists.map((key,i)=>{
                pages.push(
                    <TouchableOpacity
                        ...
                        onPress={() =>this.props.navigation.navigate('PaymentDrawerDetails')}>
...
const App = createStackNavigator(
    {
        PaymentDrawerDetails:{
            screen:PaymentDrawerDetails,
        ...
        initialRouteName: 'paymentDr',
    });

const AppContainer = createAppContainer(App);
export default class paymentDrawer extends React.Component {
    render() {
        return <AppContainer />;
    }
}
