...
class paymentInformationUp extends React.Component{
    constructor(props) {
        super(props);
        this.state = {
            inputValue: "12.32",
            MValue:'',
            avatarSource: [[{'uri':'https://avatars2.githubusercontent.com/u/7970947?v=3&s=460")'}]],
            array:[],
            videoSource: null,
            i:0,
            presetDate: new Date(),
            ...
            <View  style={{flex:1,backgroundColor:'#eeeeee'}}>
                <ScrollView>
                    <View style={{backgroundColor:'white',marginTop:10}}>
                        <View>
                            <Text style={{marginLeft:'3%',fontSize:15,marginTop:10,marginBottom:10}}>经办人：</Text>
                        ...
                        <View>
                            <Text style={{marginLeft:'3%',fontSize:15,marginTop:10,marginBottom:10}}>收款方：</Text>
                            <View style={{marginLeft:'3%',marginRight:'3%',fontSize:15}}>
                                <TextInput
                                    placeholder="请输入乙方名称"
                                    editable={true}//是否可编辑
...
const App = createStackNavigator(
    {
        paymentInformationUp: {
            screen:paymentInformationUp,
        ...
        initialRouteName: 'paymentInformationUp',
    });

const AppContainer = createAppContainer(App);
export default class paymentInformationUpdate extends React.Component {
    render() {
        return <AppContainer />;
    }
}
